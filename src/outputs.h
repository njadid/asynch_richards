...
float Output_State8(unsigned int id, double t, double *y, unsigned int num_dof);
float Output_State9(unsigned int id, double t, double *y, unsigned int num_dof);
float Output_State10(unsigned int id, double t, double *y, unsigned int num_dof);
float Output_State11(unsigned int id, double t, double *y, unsigned int num_dof);
float Output_State12(unsigned int id, double t, double *y, unsigned int num_dof);
float Output_State13(unsigned int id, double t, double *y, unsigned int num_dof);
